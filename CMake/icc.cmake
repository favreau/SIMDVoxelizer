...
# these flags apply ONLY to how embree is built; the rest of the SIMDVOXELIZER C++ code is ISA-agnostic
SET(ISPC_ARCH_SSE3    "-msse3")
SET(ISPC_ARCH_SSSE3   "-mssse3")
SET(ISPC_ARCH_SSE41   "-msse4.1")
SET(ISPC_ARCH_SSE42   "-msse4.2")
SET(ISPC_ARCH_AVX     "-mavx")
SET(ISPC_ARCH_AVX2   "-mf16c -mavx2 -mfma -mlzcnt -mbmi -mbmi2")
SET(ISPC_ARCH_AVX512 "-mavx512f -mavx512pf -mavx512er -mavx512cd")
...
IF (ICC_VERSION VERSION_LESS ICC_VERSION_REQUIRED)
  MESSAGE(FATAL_ERROR "ICC version ${ICC_VERSION_REQUIRED} or greater is required to build SIMDVOXELIZER.")
ENDIF()

# ICC 4.8.0 supports AVX and AVX2...
SET(ISPC_COMPILER_SUPPORTS_AVX TRUE)
SET(ISPC_COMPILER_SUPPORTS_AVX2 TRUE)

SET(ICC_VERSION_REQUIRED_AVX512 "15.0.0")

IF (ICC_VERSION VERSION_LESS ICC_VERSION_REQUIRED_AVX512)
  SET(ISPC_COMPILER_SUPPORTS_AVX512 FALSE)
ELSE()
  SET(ISPC_COMPILER_SUPPORTS_AVX512 TRUE)
ENDIF()
